...
class Controller:
    def __init__( self, kp, ki, kd ):
        ...
        self.prev_e = 0  # Last error (for deriv calc)
    ...
    def work( self, e ):
        ...
        self.prev_e = e
        self.i += e
        return self.kp*e + self.ki*self.i + self.kd*(e - prev) 
...
def closed_loop( c, p, tm=5000 ):
    ...
    """
    def setpoint( t ):
        return t/100.0 #gradually increases in time
        # if t < 100: return 0
        # if t < 300: return 50
        # return 10
